...
export const PROVINCES: Record<string, ProvinceInfo> = {
  fujian: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/36675564/15547655_1440_2560_30fps.mp4",
    featuredCities: ["xiamen", "fuzhou", "wuyishan", "quanzhou"],
  ...
  yunnan: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/35410612/15003298_2560_1440_30fps.mp4",
    featuredCities: ["lijiang", "dali", "kunming", "xishuangbanna", "shangrila"],
  ...
  sichuan: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/37728648/16002008_2560_1440_60fps.mp4",
    featuredCities: ["chengdu", "leshan", "emeishan", "jiuzhaigou", "daocheng"],
  ...
  guangdong: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/35987650/15259365_2560_1440_60fps.mp4",
    featuredCities: ["guangzhou", "shenzhen", "zhuhai"],
  ...
  guangxi: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/36932826/15646257_1920_1080_30fps.mp4",
    featuredCities: ["guilin", "yangshuo", "nanning", "beihai"],
  ...
  zhejiang: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/35214757/14917980_2560_1440_24fps.mp4",
    featuredCities: ["hangzhou", "ningbo", "shaoxing", "zhoushan", "wuzhen"],
  ...
  jiangsu: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/32790353/13977236_2560_1440_24fps.mp4",
    featuredCities: ["nanjing", "suzhou", "yangzhou", "wuxi", "zhenjiang"],
  ...
  shaanxi: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/35195642/14911608_2560_1440_60fps.mp4",
    featuredCities: ["xian", "yanan"],
  ...
  hainan: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/32454730/13841482_2560_1440_30fps.mp4",
    featuredCities: ["sanya", "haikou", "wenchang"],
  ...
  beijing: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/35548691/15060791_2560_1440_30fps.mp4",
    featuredCities: ["beijing_city", "yanqing"],
  ...
  shanghai: {
    ...
    heroVideo:
      "https://videos.pexels.com/video-files/36926086/15642999_2560_1440_25fps.mp4",
    featuredCities: ["shanghai_city", "zhujiajiao"],
    highlights: ["The Bund", "Yu Garden", "French Concession", "Pudong skyline"],
  },
  // Minimal data for remaining provinces
  hebei: { id: "hebei", nameZh: "河北", nameEn: "Hebei", tagline: "Gateway to the north", description: "Surrounding Beijing, Hebei offers the Great Wall at Chengde, the port city of Qinhuangdao, and the imperial summer retreats of the Qing dynasty.", image: "https://images.unsplash.com/photo-1525038083052-41b3b8c91e55?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/1193306/1193306-uhd_2560_1440_30fps.mp4", featuredCities: ["chengde", "qinhuangdao"], highlights: ["Chengde Mountain Resort", "Shanhaiguan Pass", "Baiyangdian Lake"] },
  shanxi: { id: "shanxi", nameZh: "山西", nameEn: "Shanxi", tagline: "Ancient temples & coal country", description: "One of the cradles of Chinese civilisation, with remarkable Buddhist cave temples at Yungang and the ornate Pingyao ancient city.", image: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/30828740/13184393_2560_1440_24fps.mp4", featuredCities: ["datong", "pingyao", "wutaishan"], highlights: ["Pingyao Ancient City", "Yungang Grottoes", "Hanging Temple"] },
  liaoning: { id: "liaoning", nameZh: "辽宁", nameEn: "Liaoning", tagline: "Old industry meets coastal beauty", description: "The gateway to northeast China, with the Shenyang Imperial Palace rivalling Beijing's Forbidden City, and the old Japanese architecture of Dalian.", image: "https://images.unsplash.com/photo-1509629179375-1c38ad17e47c?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/33657661/14301113_2560_1440_60fps.mp4", featuredCities: ["shenyang", "dalian", "dandong"], highlights: ["Shenyang Imperial Palace", "Dalian coastline", "Bingyu Valley"] },
  jilin: { id: "jilin", nameZh: "吉林", nameEn: "Jilin", tagline: "Ice forests & volcanic lakes", description: "Home to China's spectacular winter wonderland — the ice-rimed trees of Jilin city, and the volcanic crater lake of Changbai Mountain.", image: "https://images.unsplash.com/photo-1601766994656-00d5c8b89f71?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/36061762/15293315_1080_1920_30fps.mp4", featuredCities: ["changbaishan", "jilin_city"], highlights: ["Changbai Mountain", "Tianchi Lake", "Jilin rime ice forest"] },
  heilongjiang: { id: "heilongjiang", nameZh: "黑龙江", nameEn: "Heilongjiang", tagline: "China's winter capital", description: "The Harbin International Ice and Snow Sculpture Festival is one of the world's great spectacles. In summer, Zhalong Nature Reserve is alive with red-crowned cranes.", image: "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/30921669/13223725_2560_1440_60fps.mp4", featuredCities: ["harbin", "mohe"], highlights: ["Harbin Ice Festival", "Siberian Tiger Park", "Saint Sophia Cathedral"] },
  anhui: { id: "anhui", nameZh: "安徽", nameEn: "Anhui", tagline: "Ink-wash paintings come to life", description: "The mist-wrapped peaks of Huangshan inspired a thousand Chinese paintings, and the UNESCO-listed Hongcun village looks exactly like one of them.", image: "https://images.unsplash.com/photo-1596895111956-bf1cf0599ce5?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/18069018/18069018-uhd_2560_1440_30fps.mp4", featuredCities: ["huangshan", "hongcun", "hefei", "wuyuan_an", "jiuhuashan"], highlights: ["Huangshan (Yellow Mountain)", "Hongcun Village", "Xidi Village"] },
  jiangxi: { id: "jiangxi", nameZh: "江西", nameEn: "Jiangxi", tagline: "Porcelain & mountain pilgrimage", description: "Jingdezhen has produced China's finest porcelain for over a thousand years. Wuyuan's golden rapeseed fields each spring are among China's most photographed landscapes.", image: "https://images.unsplash.com/photo-1562329265-95a6d7a83440?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/11378389/11378389-hd_1920_1080_60fps.mp4", featuredCities: ["jingdezhen", "lushan", "nanchang", "wuyuan_an", "longhushan"], highlights: ["Jingdezhen porcelain", "Mount Lu", "Wuyuan countryside"] },
  shandong: { id: "shandong", nameZh: "山东", nameEn: "Shandong", tagline: "Confucius, Taishan & seafood", description: "The birthplace of Confucius, the sacred Mount Tai, and the German-influenced seaside city of Qingdao where China's favourite beer is brewed.", image: "https://images.unsplash.com/photo-1590002949416-e42f6e80e8b1?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/30806440/13176158_2560_1440_25fps.mp4", featuredCities: ["qingdao", "taishan", "qufu", "jinan", "yantai"], highlights: ["Mount Tai", "Qufu Confucius Temple", "Qingdao coastline"] },
  henan: { id: "henan", nameZh: "河南", nameEn: "Henan", tagline: "The cradle of Chinese civilisation", description: "Luoyang's Longmen Grottoes, the Shaolin Monastery where kung fu was born, and Kaifeng's Song dynasty street food culture.", image: "https://images.unsplash.com/photo-1584646098378-0e4e9b671fbf?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/34385799/14566911_2560_1440_60fps.mp4", featuredCities: ["luoyang", "kaifeng", "dengfeng", "anyang"], highlights: ["Longmen Grottoes", "Shaolin Temple", "White Horse Temple"] },
  hubei: { id: "hubei", nameZh: "湖北", nameEn: "Hubei", tagline: "The heart of China", description: "Wuhan is one of China's great unsung cities — hot dry noodles for breakfast, cherry blossoms in spring, and the historic Yangtze river crossing that defined the country.", image: "https://images.unsplash.com/photo-1597586124394-fbd6ef244026?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/36348002/15416662_2560_1440_30fps.mp4", featuredCities: ["wuhan", "wudangshan", "enshi", "yichang", "shennongjia"], highlights: ["Yellow Crane Tower", "Wuhan hot dry noodles", "Three Gorges"] },
  hunan: { id: "hunan", nameZh: "湖南", nameEn: "Hunan", tagline: "Avatar mountains & fiery food", description: "The otherworldly sandstone pillars of Zhangjiajie inspired Avatar's Hallelujah Mountains. Changsha is one of China's most exciting food and nightlife cities.", image: "https://images.unsplash.com/photo-1555737785-3b6a6f9cd8f5?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/5996220/5996220-hd_1920_1080_30fps.mp4", featuredCities: ["zhangjiajie", "changsha", "fenghuang", "yueyang", "hengshan"], highlights: ["Zhangjiajie National Park", "Fenghuang Old Town", "Hunan cuisine"] },
  guizhou: { id: "guizhou", nameZh: "贵州", nameEn: "Guizhou", tagline: "Waterfalls & minority culture", description: "Huangguoshu Waterfall, the largest in Asia, and villages of the Miao and Dong minorities with their elaborate silver headdresses and drum towers.", image: "https://images.unsplash.com/photo-1596265371388-43edbaadab94?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/31157383/13312646_2560_1440_30fps.mp4", featuredCities: ["guiyang", "kaili", "zhenyuan", "huangguoshu", "libo"], highlights: ["Huangguoshu Waterfall", "Miao minority villages", "Maotai baijiu"] },
  tianjin: { id: "tianjin", nameZh: "天津", nameEn: "Tianjin", tagline: "European streets beside the Hai River", description: "An hour from Beijing by high-speed rail, Tianjin has Italian, French, and British colonial architecture alongside Goubuli steamed buns and traditional Chinese folk art.", image: "https://images.unsplash.com/photo-1568895706332-28c5e023adcc?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/17138430/17138430-hd_1920_1080_30fps.mp4", featuredCities: ["tianjin_city", "jizhou"], highlights: ["Wudadao European Quarter", "Ancient Culture Street", "Goubuli dumplings"] },
  chongqing: { id: "chongqing", nameZh: "重庆", nameEn: "Chongqing", tagline: "Mountain city of fog & fire", description: "China's most dramatic city, built on cliffs above two rivers. Spicy Chongqing hotpot fuels a nightlife scene that rivals Shanghai, on a fraction of the budget.", image: "https://images.unsplash.com/photo-1558704164-ab7a0016c1f3?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/34766462/14738995_2560_1440_24fps.mp4", featuredCities: ["chongqing", "wulong"], highlights: ["Jiefangbei district", "Chongqing hotpot", "Three Gorges cruise", "Ciqikou Old Town"] },
  gansu: { id: "gansu", nameZh: "甘肃", nameEn: "Gansu", tagline: "Where the Silk Road lives", description: "The Mogao Grottoes at Dunhuang hold 1,600 years of Buddhist art, the Rainbow Mountains of Zhangye glow in the evening light, and the last section of the Great Wall watches over it all.", image: "https://images.unsplash.com/photo-1565128939960-1ec0a5e46e93?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/35979150/15256437_2560_1440_60fps.mp4", featuredCities: ["dunhuang", "zhangye", "jiayuguan"], highlights: ["Dunhuang Mogao Caves", "Zhangye Rainbow Mountains", "Jiayuguan Fort"] },
  qinghai: { id: "qinghai", nameZh: "青海", nameEn: "Qinghai", tagline: "The roof of China's roof", description: "Qinghai Lake is the largest lake in China, ringed by yellow rapeseed in summer. The Tibetan town of Tongren is a living centre of Tibetan Buddhist thangka painting.", image: "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/36436531/15450730_2560_1440_30fps.mp4", featuredCities: ["xining", "qinghai_lake", "tongren_qh", "golmud", "qilian"], highlights: ["Qinghai Lake", "Ta'er Monastery", "Tongren Tibetan art"] },
  neimenggu: { id: "neimenggu", nameZh: "内蒙古", nameEn: "Inner Mongolia", tagline: "Grasslands, yurts & starry skies", description: "Hulunbuir's grasslands are among the most pristine in the world. Sleeping in a yurt, watching the Milky Way, and riding horses at sunrise — Inner Mongolia delivers an experience China rarely talks about.", image: "https://images.unsplash.com/photo-1548786811-dd6e453ccca7?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/4360054/4360054-uhd_2562_1440_25fps.mp4", featuredCities: ["hohhot", "hulunbuir", "ejina"], highlights: ["Hulunbuir Grasslands", "Gegentala Sky Camp", "Resonant Sand Gorge"] },
  xizang: { id: "xizang", nameZh: "西藏", nameEn: "Tibet", tagline: "Roof of the world", description: "The Potala Palace, sacred Jokhang Temple, and monasteries dotting the Tibetan plateau. Tibet requires advance permits and is best visited with a guided tour.", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/11300604/11300604-hd_1920_1080_60fps.mp4", featuredCities: ["lhasa", "shigatse", "nyingchi", "namtso", "zhada"], highlights: ["Potala Palace", "Jokhang Temple", "Namtso Lake", "Everest Base Camp"] },
  xinjiang: { id: "xinjiang", nameZh: "新疆", nameEn: "Xinjiang", tagline: "Central Asia meets China", description: "Kashgar's Sunday market, the turquoise Karakul Lake, and Grape Valley in Turpan. Xinjiang is China's largest province and its most Central Asian in character.", image: "https://images.unsplash.com/photo-1567634698-89e6da2e8c6d?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/37795840/16032094_2560_1440_25fps.mp4", featuredCities: ["kashgar", "urumqi", "turpan", "ili", "kanas"], highlights: ["Kashgar Old City", "Heavenly Lake", "Grape Valley", "Kuqa Grand Canyon"] },
  ningxia: { id: "ningxia", nameZh: "宁夏", nameEn: "Ningxia", tagline: "Desert, stars & Halal cuisine", description: "The Western Xia Imperial Tombs echo the pyramids, the Shapotou Desert meets the Yellow River in a single view, and Ningxia's Halal lamb is some of the best in China.", image: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800&h=500&fit=crop", heroVideo: "https://videos.pexels.com/video-files/37469783/15871273_1920_1080_25fps.mp4", featuredCities: ["yinchuan", "zhongwei"], highlights: ["Western Xia Imperial Tombs", "Shapotou Desert", "Yellow River scenery"] },
};

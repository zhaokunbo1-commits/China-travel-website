...
export const PROVINCES: Record<string, ProvinceInfo> = {
  ...
  anhui: { id: "anhui", nameZh: "安徽", nameEn: "Anhui", tagline: "Ink-wash paintings come to life", description: "The mist-wrapped peaks of Huangshan inspired a thousand Chinese paintings, and the UNESCO-listed Hongcun village looks exactly like one of them.", image: "https://images.unsplash.com/photo-1596895111956-bf1cf0599ce5?w=800&h=500&fit=crop", featuredCities: [], highlights: ["Huangshan (Yellow Mountain)", "Hongcun Village", "Xidi Village"] },
  ...
  shandong: { id: "shandong", nameZh: "山东", nameEn: "Shandong", tagline: "Confucius, Taishan & seafood", description: "The birthplace of Confucius, the sacred Mount Tai, and the German-influenced seaside city of Qingdao where China's favourite beer is brewed.", image: "https://images.unsplash.com/photo-1590002949416-e42f6e80e8b1?w=800&h=500&fit=crop", featuredCities: [], highlights: ["Mount Tai", "Qufu Confucius Temple", "Qingdao coastline"] },
  henan: { id: "henan", nameZh: "河南", nameEn: "Henan", tagline: "The cradle of Chinese civilisation", description: "Luoyang's Longmen Grottoes, the Shaolin Monastery where kung fu was born, and Kaifeng's Song dynasty street food culture.", image: "https://images.unsplash.com/photo-1584646098378-0e4e9b671fbf?w=800&h=500&fit=crop", featuredCities: [], highlights: ["Longmen Grottoes", "Shaolin Temple", "White Horse Temple"] },

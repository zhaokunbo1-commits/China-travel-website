...
export const PROVINCES: Record<string, ProvinceInfo> = {
  ...
  shaanxi: {
    ...
    featuredCities: ["xian", "yanan", "hanzhong", "huashan"],
  ...
  hebei: { id: "hebei", nameZh: "河北", nameEn: "Hebei", tagline: "Gateway to the north", description: "Surrounding Beijing, Hebei offers the Great Wall at Chengde, the port city of Qinhuangdao, and the imperial summer retreats of the Qing dynasty.", image: "https://images.unsplash.com/photo-1525038083052-41b3b8c91e55?w=800&h=500&fit=crop", featuredCities: ["chengde", "qinhuangdao"], highlights: ["Chengde Mountain Resort", "Shanhaiguan Pass", "Baiyangdian Lake"] },
  shanxi: { id: "shanxi", nameZh: "山西", nameEn: "Shanxi", tagline: "Ancient temples & coal country", description: "One of the cradles of Chinese civilisation, with remarkable Buddhist cave temples at Yungang and the ornate Pingyao ancient city.", image: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800&h=500&fit=crop", featuredCities: ["datong", "pingyao", "wutaishan"], highlights: ["Pingyao Ancient City", "Yungang Grottoes", "Hanging Temple"] },
  liaoning: { id: "liaoning", nameZh: "辽宁", nameEn: "Liaoning", tagline: "Old industry meets coastal beauty", description: "The gateway to northeast China, with the Shenyang Imperial Palace rivalling Beijing's Forbidden City, and the old Japanese architecture of Dalian.", image: "https://images.unsplash.com/photo-1509629179375-1c38ad17e47c?w=800&h=500&fit=crop", featuredCities: ["shenyang", "dalian", "dandong"], highlights: ["Shenyang Imperial Palace", "Dalian coastline", "Bingyu Valley"] },
  jilin: { id: "jilin", nameZh: "吉林", nameEn: "Jilin", tagline: "Ice forests & volcanic lakes", description: "Home to China's spectacular winter wonderland — the ice-rimed trees of Jilin city, and the volcanic crater lake of Changbai Mountain.", image: "https://images.unsplash.com/photo-1601766994656-00d5c8b89f71?w=800&h=500&fit=crop", featuredCities: ["changbaishan", "jilin_city"], highlights: ["Changbai Mountain", "Tianchi Lake", "Jilin rime ice forest"] },
  heilongjiang: { id: "heilongjiang", nameZh: "黑龙江", nameEn: "Heilongjiang", tagline: "China's winter capital", description: "The Harbin International Ice and Snow Sculpture Festival is one of the world's great spectacles. In summer, Zhalong Nature Reserve is alive with red-crowned cranes.", image: "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800&h=500&fit=crop", featuredCities: ["harbin", "mohe"], highlights: ["Harbin Ice Festival", "Siberian Tiger Park", "Saint Sophia Cathedral"] },
  ...
  jiangxi: { id: "jiangxi", nameZh: "江西", nameEn: "Jiangxi", tagline: "Porcelain & mountain pilgrimage", description: "Jingdezhen has produced China's finest porcelain for over a thousand years. Wuyuan's golden rapeseed fields each spring are among China's most photographed landscapes.", image: "https://images.unsplash.com/photo-1562329265-95a6d7a83440?w=800&h=500&fit=crop", featuredCities: ["jingdezhen", "lushan", "nanchang", "wuyuan_an", "longhushan"], highlights: ["Jingdezhen porcelain", "Mount Lu", "Wuyuan countryside"] },
  shandong: { id: "shandong", nameZh: "山东", nameEn: "Shandong", tagline: "Confucius, Taishan & seafood", description: "The birthplace of Confucius, the sacred Mount Tai, and the German-influenced seaside city of Qingdao where China's favourite beer is brewed.", image: "https://images.unsplash.com/photo-1590002949416-e42f6e80e8b1?w=800&h=500&fit=crop", featuredCities: ["qingdao", "taishan", "qufu", "jinan", "yantai"], highlights: ["Mount Tai", "Qufu Confucius Temple", "Qingdao coastline"] },
